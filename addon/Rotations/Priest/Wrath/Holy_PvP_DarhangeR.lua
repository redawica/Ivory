...
local items = {
	...
	{ type = "title", text = "Priest Holy PvP by |c0000CED1DarhangeR" },
	{ type = "separator" },
...
-----------------------------------
	["Window"] = function()
		if not popup_shown then
			ni.debug.popup("Priest Holy PvP by DarhangeR for 3.3.5a", "Welcome to Priest Holy PvP profile. Racials are configured for PvP mode.")
			popup_shown = true;
		end
	end,
}
