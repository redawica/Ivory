...
local items = {
	settingsfile = "DarhangeR_Protection_Paladin_PvP.xml",
	{ type = "title", text = "Paladin Protection Paladin PvP by |c0000CED1DarhangeR" },
	{ type = "separator" },
...
local function OnLoad()
	ni.GUI.AddFrame("Protection_Paladin_PvP_DarhangeR", items);
end

local function OnUnLoad()
	ni.GUI.DestroyFrame("Protection_Paladin_PvP_DarhangeR");
end
...
-----------------------------------
	["Window"] = function()
		if not popup_shown then
			ni.debug.popup("Paladin Protection Paladin PvP by DarhangeR for 3.3.5a", "Welcome to Paladin Protection Paladin PvP profile. Racials are configured for PvP mode.")
			popup_shown = true;
		end
	end,
}

ni.bootstrap.profile("Protection_Paladin_PvP_DarhangeR", queue, abilities, OnLoad, OnUnLoad);
else
	local queue = { "Error" }
	local abilities = {
		["Error"] = function()
	...
	ni.bootstrap.profile("Protection_Paladin_PvP_DarhangeR", queue, abilities);
end
