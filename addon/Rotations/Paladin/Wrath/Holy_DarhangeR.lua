...
local items = {
	...
	{ type = "separator" },
	{ type = "dropdown", menu = {
		{ selected = true, value = 0, text = "|T"..(select(3, GetSpellInfo(20473)) or "")..":20:20|t DPS Mode: Auto" },
		{ selected = false, value = 1, text = "|T"..(select(3, GetSpellInfo(48825)) or "")..":20:20|t DPS Mode: Holy Shock" },
		{ selected = false, value = 2, text = "|T"..(select(3, GetSpellInfo(48806)) or "")..":20:20|t DPS Mode: Hammer of Wrath" },
	}, key = "dpsmode" },
	{ type = "dropdown", menu = {
		{ selected = true, value = 0, text = "Active Seals: Auto mode" },
